...
\begin{minipage}[t]{0.5\textwidth} % 45% of the page width for name
	...
	\colorbox{black}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{Steven Dirth}}}}} % First name
	
%	\colorbox{black}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{Dirth}}}}} % Last name
...
\end{minipage}
\begin{minipage}[t]{0.47\textwidth} % 58% of the page width for the first row of icons
	\vspace{-\baselineskip} % Required for vertically aligning minipages
	{\large
